...
import numpy as np
import copy
from scratch_implemented.deep_learning.activations import Sigmoid, ReLU, SoftPlus, LeakyReLU
from scratch_implemented.deep_learning.activations import TanH, ELU, SELU, Softmax
